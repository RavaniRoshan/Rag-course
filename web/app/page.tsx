...
export default function LandingPage() {
  return (
    <div className="flex flex-col">
      ...
      <section id="onboarding" className="border-t bg-primary/5">
      ...
      <section id="mobile" className="container mx-auto px-4 py-16 md:py-24">
      ...
      <section id="audience" className="container mx-auto px-4 py-16 md:py-24">
      ...
      <section id="ecosystem" className="border-t bg-primary/5">
      ...
      <section id="newsletter" className="container mx-auto px-4 py-16 md:py-24">
      ...
      <section id="footer-cta" className="border-t bg-muted/30">
